...
export PROOF_MANAGER_SUBMITTER_ADDRESS=${PROOF_MANAGER_SUBMITTER_ADDRESS:-"0x0000000000000000000000000000000000000001"}
export PROXY_OWNER_ADDRESS=${PROXY_OWNER_ADDRESS:-"0x0000000000000000000000000000000000000001"}
export ADMIN_ADDRESS=${ADMIN_ADDRESS:-"0x0000000000000000000000000000000000000001"}
...
echo "PROOF_MANAGER_SUBMITTER_ADDRESS: $PROOF_MANAGER_SUBMITTER_ADDRESS"
